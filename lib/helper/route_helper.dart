...
class RouteHelper {
  ...
  //static String getChatRoute() => '$messages';
  ...
  static String getChatRoute({@required NotificationBody notificationBody, User user, int conversationID, int index}) {
    ...
    //return '$messages?notification=$_notificationBody&conversation_id=$conversationID&index=$index';
    return '$messages?notification=$_notificationBody&user=$_user&conversation_id=$conversationID&index=$index';
    //return '$messages';
  }

  // static String getChatRouteConversation({@required NotificationBody notificationBody, User user, int conversationID, int index}) {
  //   String _notificationBody = 'null';
  //   if(notificationBody != null) {
  //     _notificationBody = base64Encode(utf8.encode(jsonEncode(notificationBody.toJson())));
  //   }
  ...
  //static String getMessageRoute() => '$messages';
  ...
  static List<GetPage> routes = [
   ...
   // GetPage(name: messages, page: () => ChatScreen()),
  ];
