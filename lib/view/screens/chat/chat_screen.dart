...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void initState() {
    ...
    _isLoggedIn = Get.find<AuthController>().isLoggedIn();
     ...
     print('notificationBody:'+widget.notificationBody.customerId.toString());
    //
    // AdminId:'+widget.notificationBody.
    // adminId.toString()+' CustomerId:'+widget.notificationBody.
    // customerId.toString());
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ChatController>(builder: (chatController) {
      ...
      return Scaffold(
        appBar:
        //ResponsiveHelper.isDesktop(context) ? WebMenuBar() :
        AppBar(
          // title: Text(widget.user != null ? '${widget.user.fName}'
          //     ' ${widget.user.lName}' : 'receiver_name'.tr),
          title: Text(chatController.messageModel != null ? '${chatController.messageModel.conversation.sender.fName}'
              ' ${chatController.messageModel.conversation.sender.lName}' : ''),
        ...
        body: _isLoggedIn ? SafeArea(
          child: Center(
            child: Container(
              width:
              //ResponsiveHelper.isDesktop(context) ? Dimensions.WEB_MAX_WIDTH :
                    ...
                    child: PaginatedListView(
                      ...
                      productView: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return
                         // Text(chatController.messageModel.messages[index].message);
                            MessageBubble(
                            ...
                            //     : widget.notificationBody.deliverymanId != null ? UserType.delivery_man : UserType.vendor,
                              isCurrentUser: chatController.messageModel.messages[index].senderId == widget.notificationBody.customerId? false:true,
                              msgModel: chatController.messageModel,
                          );
                      ...
                      Expanded(
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintStyle: robotoRegular.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.FONT_SIZE_SMALL),
                          ),
