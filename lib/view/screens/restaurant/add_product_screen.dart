            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Row(children: [
                ...
                Expanded(child: CustomTimePicker(
                  title: 'available_time_starts'.tr, time: _product.availableTimeStarts != null? _product.availableTimeStarts : '00:01',
                  onTimeChanged: (time) => _product.availableTimeStarts = time ,
                )),
                SizedBox(width: Dimensions.PADDING_SIZE_SMALL),

                Expanded(child: CustomTimePicker(
                  title: 'available_time_ends'.tr, time: _product.availableTimeEnds!= null? _product.availableTimeEnds : '23:59',
