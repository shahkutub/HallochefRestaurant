    ...
    return Scaffold(
      ...
      body: GetBuilder<OrderController>(builder: (orderController) {
        ...
        if(orderController.orderDetailsModel != null) {
          ...
          _discount = _order.restaurantDiscountAmount != null? _order.restaurantDiscountAmount:0.0;
          _tax = _order.totalTaxAmount != null?_order.totalTaxAmount : 0.0;
          _couponDiscount = _order.couponDiscountAmount !=null ?  _order.couponDiscountAmount : 0.0;
        ...
        return orderController.orderDetailsModel != null && _order.scheduleAt != null?
        Column(children: [
          ...
          Expanded(child: Scrollbar(child: SingleChildScrollView(
            ...
            child: Center(child: SizedBox(width: 1170, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              InkWell(
                onTap: () async {
                  // print('custid'+_order.customer.id.toString());
                  // await Get.toNamed(
                  //   RouteHelper.getConversationRoute()
                  //     // RouteHelper.getChatRoute(
                  //     //   notificationBody: NotificationBody(orderId: _order.id, customerId: _order.customer.id),
                  //     //   user: User(id: _order.customer.id, fName: _order.customer.fName, lName: '', image: _order.customer.image),
                  //     // )
                  // );
                },
                child:Row(children: [
              ...
              Row(children: [
                ...
                TextButton.icon(
                  onPressed: () async {
                    ...
                    // Get.find<ChatController>().conversationModel.conversation.forEach((element) {
                    //  // print(' _order.customer.id'+ _order.customer.id.toString()+', '+element.senderId.toString());
                    //
                    //   if( _order.customer.id == element.senderId){
                    //     print(' _order.customer.id'+ _order.customer.id.toString()+', '+element.senderId.toString());
                    //
                    ...
                    //  // conversationID: _order.customer.,
                    //   notificationBody: NotificationBody(orderId: _order.id, customerId: _order.customer.id),
                    //   user: User(id: _order.customer.id, fName: _order.customer.fName, lName: '', image: _order.customer.image),
                    // ));
