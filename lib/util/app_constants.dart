...
class AppConstants {
  static const String APP_NAME = 'Hallo Chef Restaurant';
  ...
  static  User userInfoModel ;
  static const String CUSTOMER_INFO_URI = '/api/v1/vendor/profile';
  static const String CUSTOMER_REMOVE = '/api/v1/vendor/remove-account';
  static const String CONVERSATION_LIST_URI = '/api/v1/vendor/message/list';
  static const String SEARCH_CONVERSATION_LIST_URI = '/api/v1/vendor/message/search-list';
  static const String MESSAGE_LIST_URI = '/api/v1/vendor/message/details';
